-- =====================================================
-- CORRIGIR/ATUALIZAR TABELA DE TRANSCRIÇÕES
...
-- Se a tabela tiver estrutura diferente, vamos dropar e recriar
DROP TABLE IF EXISTS public.transcriptions CASCADE;

-- Criar tabela de transcrições do zero
...
-- Deve mostrar todas as colunas corretas agora!
